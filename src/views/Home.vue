<template>
    <div>
        <div class="lg:bg-[linear-gradient(90deg,_white_70%,_pink_70%)]">
  ...
  <div class="mx-auto mt-20 px-4 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
    <div class="flex flex-col items-center justify-between lg:flex-row">
      <div class="lg:max-w-lg lg:pr-5">
        ...
        <div class="mb-6 max-w-xl">
          ...
          <h2 class="mb-6 max-w-lg text-3xl font-bold leading-snug tracking-tight text-blue-600 sm:text-5xl sm:leading-snug">
            𝖉𝖗𝖊𝖆𝖒 𝖆𝖈𝖈𝖊𝖘𝖘𝖔𝖗𝖎𝖊𝖘
            <span class="my-1 inline-block border-b-8 border-orange-600 text-blue-600">s̴w̴e̴e̴t̴</span>
            𝓵𝓪𝓭𝓲𝓮𝓼
          </h2>
      ...
      <div class="relative text-blue-600 lg:ml-32 lg:w-1/2 hidden lg:block">
        <div class="border-b-8 border-b-blue-600 max-w-lg mx-auto mb-10">
          <img class="w-full h-full object-contain" src="../images/logo.jpg" alt="" />
        </div>
      </div>
    </div>
  </div>
