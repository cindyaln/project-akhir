<template>
  ...
  <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
          ...
          <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
              <div v-for="product in getCart" :key="product.cart_id"
                  ...
                  <img class="m-2 h-24 w-28 rounded-md border object-cover object-center"
                      src="https://i.pinimg.com/474x/ac/29/d6/ac29d63ddc4c061096c57c7d3b26906f.jpg"
                      alt="" />
      ...
      <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
          ...
          <div class="mb-4">
<router-link to="/order/:orderCode" class="group inline-flex w-full items-center justify-center rounded-md bg-gray-900 px-6 py-4 text-lg font-semibold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-gray-800"
                            type="submit">place older</router-link>
</div>
      </div>
  </div>
</template>
