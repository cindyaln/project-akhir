          ...
          <div v-if="product">
              ...
              <div class="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
                      ...
                      <div class="lg:flex lg:items-start">
                          <div class="lg:order-2 lg:ml-5">
                              <div class="max-w-xl overflow-hidden rounded-lg">
                                  <img class="h-full w-full max-w-full object-cover w-full" src="https://www.logoground.com/uploads/201657912016-02-292506544accessories-business.jpg" alt="" />
                              </div>
                          </div>
                          ...
                          <div class="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
                              <div class="flex flex-row items-start lg:flex-col">
                                  <button type="button"
                                      ...
                                      <img class="h-full w-full object-cover" src="https://www.logoground.com/uploads/201657912016-02-292506544accessories-business.jpg" alt="" />
                                  </button>
                                  <button type="button"
                  ...
                  <div class="lg:col-span-2 lg:row-span-2 lg:row-end-2">
                      ...
                      <h2 class="mt-8 text-base text-gray-900">detail</h2>
